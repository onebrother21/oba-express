...
export declare type OBAExpressApiConfigType<Sockets = undefined> = OBACoreConfig & Partial<{
...
export declare type OBAExpressApiBaseType<Ev = undefined, Sockets = undefined> = Omit<OBACoreApi<Ev>, "config"> & OBAExpressApiBaseTypeMethods & {
